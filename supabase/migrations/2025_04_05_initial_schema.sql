...
CREATE FUNCTION public.exec_sql(sql_query text) RETURNS SETOF json
...
--
-- Name: adventures; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.adventures ENABLE ROW LEVEL SECURITY;

--
-- Name: adventures adventures_policy; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY adventures_policy ON public.adventures USING (true) WITH CHECK (true);
...
--
-- Name: bookings bookings_policy; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY bookings_policy ON public.bookings USING (true) WITH CHECK (true);


--
-- Name: guide_submissions; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.guide_submissions ENABLE ROW LEVEL SECURITY;

--
-- Name: guide_submissions guide_submissions_policy; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY guide_submissions_policy ON public.guide_submissions USING (true) WITH CHECK (true);
...
CREATE POLICY leads_policy ON public.leads USING (true) WITH CHECK (true);
...
--
-- Name: listings listings_policy; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY listings_policy ON public.listings USING (true) WITH CHECK (true);


--
-- Name: resorts; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.resorts ENABLE ROW LEVEL SECURITY;

--
-- Name: resorts resorts_policy; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY resorts_policy ON public.resorts USING (true) WITH CHECK (true);
...
--
-- Name: rewards rewards_policy; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY rewards_policy ON public.rewards USING (true) WITH CHECK (true);
...
--
-- Name: session session_policy; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY session_policy ON public.session USING (true) WITH CHECK (true);
...
--
-- Name: social_shares social_shares_policy; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY social_shares_policy ON public.social_shares USING (true) WITH CHECK (true);
...
--
-- Name: villas; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.villas ENABLE ROW LEVEL SECURITY;

--
-- Name: villas villas_policy; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY villas_policy ON public.villas USING (true) WITH CHECK (true);
...
--
-- Name: weather_cache weather_cache_policy; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY weather_cache_policy ON public.weather_cache USING (true) WITH CHECK (true);
