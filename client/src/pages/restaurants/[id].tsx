...
export default function RestaurantDetailsPage() {
  ...
  return (
    <>
      <SEO
        title={`${restaurant.name} - ${restaurant.cuisine} Restaurant in ${restaurant.location} | Cabo Adventures`}
        description={`Experience ${restaurant.name}, a ${restaurant.cuisine} restaurant in ${restaurant.location}. ${restaurant.description} Book your table today!`}
        canonicalUrl={`https://cabo-adventures.com/restaurants/${restaurant.id}`}
        schema={generateRestaurantSchema(restaurant)}
        openGraph={{
          title: `${restaurant.name} - ${restaurant.cuisine} Restaurant in ${restaurant.location}`,
          description: restaurant.description,
          image: restaurant.imageUrl,
          url: `https://cabo-adventures.com/restaurants/${restaurant.id}`
        }}
      />
