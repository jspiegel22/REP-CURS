...
const diningOptions: DiningOption[] = [
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?ixlib=rb-4.0.3&auto=format,compress&w=800&q=80",
    link: "/restaurants?category=fine-dining"
  },
  {
    title: "Local Cuisine",
    description: "Authentic Mexican flavors and fresh seafood",
    imageUrl: "https://images.unsplash.com/photo-1560964645-1e4aef057e8b?ixlib=rb-4.0.3&auto=format,compress&w=800&q=80",
    link: "/restaurants?category=local-cuisine"
  }
];
      ...
      <div className="container mx-auto px-4 py-16 md:py-20">
        <div className="flex flex-col md:flex-row justify-between">
          <div className="mb-8 md:w-1/3">
            ...
            <Link href="/restaurants" className="inline-flex items-center mt-2 text-[#FF8C38] hover:text-[#E67D29] font-medium">
